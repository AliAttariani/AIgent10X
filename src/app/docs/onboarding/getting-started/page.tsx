  ...
  return (
    <article className="space-y-10">
      <header className="space-y-4">
        ...
        <h1 className="text-3xl font-semibold tracking-tight">Getting started with PantherIQ</h1>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          Click <span className="font-medium text-foreground">Get started</span> on the marketing site, choose your plan, and invite the teammates who will
          review outcomes. Each workspace receives an owner role by default, plus optional admin and operator seats.
        </p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          Browse the Automations section of the dashboard. Each card includes the outcome it delivers, integrations required,
          and KPIs PantherIQ monitors on your behalf.
        </p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          PantherIQ automations stay in sync with your stack via OAuth or service accounts. Provide the minimum scopes needed
          for each integration—email, CRM, social, calendar, data warehouses, or bespoke APIs.
        </p>
        <ul className="list-disc space-y-2 pl-4 text-sm text-muted-foreground">
